// Пример теста графического дисплея с библиотекой Adafruit_GFX
...
/*
  // Большой блок русского текста для примера вывода
  tft.fillScreen(ST77XX_BLACK);
  tft.cp437(true);
  tft.setTextSize(2);
  testdrawtext(utf8rus("Пример вывода русского текста на дисплее ST7789 с библиотекой Adafruit_GFX"), ST77XX_WHITE);
  delay(2000);
*/
